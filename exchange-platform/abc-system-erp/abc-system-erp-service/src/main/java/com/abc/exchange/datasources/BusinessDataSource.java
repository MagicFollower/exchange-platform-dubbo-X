...
@Configuration
@tk.mybatis.spring.annotation.MapperScan(basePackages = "com.abc.exchange.business.dal.persistence", sqlSessionFactoryRef = "sqlSessionFactoryBusiness")
...
public class BusinessDataSource {
    ...
    public SqlSessionFactory sqlSessionFactoryBusiness(@Qualifier("dataSourceBusiness") DataSource dataSource) throws Exception {
        ...
        bean.setMapperLocations(resolveMapperLocations("classpath:com/abc/exchange/business/dal/persistence/*.xml"));
