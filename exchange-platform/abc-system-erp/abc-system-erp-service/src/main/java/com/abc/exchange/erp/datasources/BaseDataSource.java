...
@Configuration
@tk.mybatis.spring.annotation.MapperScan(basePackages = "com.abc.exchange.erp.base.dal.persistence", sqlSessionFactoryRef = "sqlSessionFactoryBase")
...
//    @Primary
    ...
    public SqlSessionFactory sqlSessionFactoryBase(@Qualifier("dataSourceBase") DataSource dataSource) throws Exception {
        ...
        bean.setMapperLocations(resolveMapperLocations("classpath:com/abc/exchange/erp/base/dal/persistence/*.xml"));
